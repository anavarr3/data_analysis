...
pg_unemployment_notices <- left_join(pg_unemployment_rate, transposed_redo_2, join_by(date)) |> 
  filter(date!="2021-01-01" & date!="2021-02-01" & date!="2021-03-01" & date!="2021-04-01" & date!="2021-05-01" & date!="2021-05-01") |> 
...
pg_unemployment_notices <- pg_unemployment_notices |>
  mutate(pg_notices = rowSums(pg_unemployment_notices[, -(1:2)]))
